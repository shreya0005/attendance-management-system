...
<div class="content">
  ...
  <div class="row" id="student">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">PRN</label>
          <div class="col-sm-7">
            <input type="text" name="st_id"  class="form-control" id="input1" placeholder="PRN" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_dept"  class="form-control" id="input1" placeholder="Department" />
          </div>
      </div>
      ...
      <input type="submit" class="loginbtn-green" value="Add Student" name="std" />
    </form>
  ...
  <div class="rowtwo" id="teacher">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="tc_id"  class="form-control" id="input1" placeholder="Teacher Id" />
          </div>
      </div>
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Name</label>
          <div class="col-sm-7">
            <input type="text" name="tc_name"  class="form-control" id="input1" placeholder="Teacher's Full Name" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="tc_course"  class="form-control" id="input1" placeholder="Subject" />
          </div>
      </div>

      <input type="submit" class="loginbtn-green" value="Add Teacher" name="tcr" />
    </form>
